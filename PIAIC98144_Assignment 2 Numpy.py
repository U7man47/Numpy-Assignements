...
def function12():
    ...
    arr = np.array([1,2,3])
    ans = np.hstack((arr[0]*1,arr[0]*1,arr[0]*1,arr[1]*1,arr[1]*1,arr[1]*1,arr[2]*1,arr[2]*1,arr[2]*1,arr,arr)) 
...
def function16():
    ...
    x = np.array([[1], [2], [3]])
    y = np.array([[2], [3], [4]])
    ans = np.vstack((x, y)).reshape(3,1,2) 
